...
import NewsImg1 from "@/public/images/news-img1.png";
import NewsImg2 from "@/public/images/news-img2.png";
import NewsImg3 from "@/public/images/news-img3.png";
...
export const Press = () => {
  return (
    <div className="py-8">
      <MaxWidthWrapper>
        <Heading className="md:text-5xl">Press Releases</Heading>
        <p className="text-xs text-[#494848] lg:w-[50%] leading-5">
          Official announcements and statements from Springfield microfinance
          bank on new developments, partnerships, products, and services
        </p>
