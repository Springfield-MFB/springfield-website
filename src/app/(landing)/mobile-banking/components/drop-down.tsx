...
import { APP_FAQ_DATA } from "@/config";
...
const FaqItem: React.FC<FaqItemProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="px-10 p-2 lg:p-6 text-xs text-[#151516] leading-6">
          {answer}
        </div>
      </div>
    </div>
...
export default MobileBankingDropdown;
