        ...
        <div className="px-8 lg:px-24 py-12 bg-brand-primary rounded-[24px]">
          <div className="grid lg:grid-cols-5 gap-x-8">
            ...
            <div className="lg:col-span-2">
              <h1 className="text-dark-primary font-extrabold text-xl">
                Our Feat
              </h1>
            ...
            {/* Counts */}
            <div className="lg:col-span-3 flex flex-row gap-8 lg:gap-0 mt-6 lg:mt-0  justify-between items-center">
              <div className="text-center">
                <h1 className="text-dark-primary text-xl lg:text-2xl font-[900]">
                  5 yrs
                </h1>
